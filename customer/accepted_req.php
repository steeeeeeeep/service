		...
		<div class = "panel panel-default">
			...
			<div class = "panel-body">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php 
							$query = $db->query("SELECT * FROM `bookings` NATURAL JOIN `transactions` NATURAL JOIN `service_info` LEFT JOIN sp_list ON sp_list.provider_id=bookings.provider_id WHERE `booking_status` = 'Accepted' && `customer_id` = '$_SESSION[customer_id]'") or die(mysqli_query());
