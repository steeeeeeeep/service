...
<body>
    ...
    <div class="container" id="container2" style="display: ;">
        ...
        <div class="form-group" style="width: 50%; margin: 10px auto" >
			...
			<input class="form-control" type="datetime-local" name="sched_date" id="sched_date">
...
<div class="table-responsive" id="container3" style="display: ;">
    <button onclick="history.back()" style="width: 100px; background: #088F8F; color: #fff; float: left;"><i class='fa fa-arrow-right'></i>Back</button>
