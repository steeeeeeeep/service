...
<body>
    ...
    <div class="container" id="container1">
        ...
        <div class="contains">
            <?php
                $query = $db_home_service_111->query("SELECT * FROM `services` WHERE cat_id='3333'");
                while($fetch = $query->fetch_array()){
            ?>
            <button type="button" name="service_type" value="<?php echo $fetch['service_name']?>" onclick="selectOption(this)"><?php echo $fetch['service_name']?></button><br>
            <?php }?>
        </div>
