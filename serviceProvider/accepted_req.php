			...
			<div class = "panel-body">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						<?php
							$query = $db->query("SELECT * FROM `bookings` NATURAL JOIN `transactions` NATURAL JOIN `customer` NATURAL JOIN `service_info` WHERE `booking_status` = 'Accepted' && `provider_id` = '$_SESSION[provider_id]' order by sched_date DESC") or die(mysqli_query());
