		...
		<div class = "panel panel-default">
			...
			<div class = "panel-body">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $db->query("SELECT * FROM `bookings` NATURAL JOIN `customer` NATURAL JOIN 	`transactions` NATURAL JOIN `service_info` WHERE `booking_status` = 'Completed'") or die(mysqli_query());
